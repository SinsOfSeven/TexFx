...
void main(
    ...
    r3.z = -r1.z * r1.w;
    r3.z = cmp(r3.z < cb0[91].y);
    r4.xy = r3.zz ? cb0[91].xy : cb0[91].yz;
    r4.zw = r3.zz ? cb0[92].xy : cb0[92].yz;
    r1.w = -r1.z * r1.w + -r4.x;
    r3.zw = r4.yw + -r4.xz;
    r3.z = max(0.00100000005, r3.z);
    r1.w = saturate(r1.w / r3.z);
    r1.w = r1.w * r3.w + r4.z;
    r3.z = cb0[115].w * cb0[90].x;
    r1.w = r3.z * r1.w;
    r1.w = v1.w * r1.w;
    ...
    r0.w = cmp(0 != cb0[102].y);
    r3.x = cmp(cb0[102].z < 0.949999988);
    r3.x = r0.w ? r3.x : 0;
    r3.y = cb1[6].x * cb0[117].w;
    r4.x = cb0[117].z * r1.z;
    r4.y = r3.y * r1.z;

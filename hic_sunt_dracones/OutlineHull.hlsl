// ---- Created with 3Dmigoto v1.3.16 on Sat Jan 27 09:42:47 2024
  ...
  out float4 o4 : TEXCOORD2)
{
  ...
  if (r0.x == 0) {
    r0.xy = cmp(float2(0,0) != cb0[35].yz);
    r0.z = cmp(abs(cb0[36].w) < 0.00100000005);
    r1.xyz = cb0[36].xyz * cb0[36].www;
    ...
    r2.xyz = cb3[5].xyz * cb0[36].yyy;
    r2.xyz = cb3[4].xyz * cb0[36].xxx + r2.xyz;
    r2.xyz = cb3[6].xyz * cb0[36].zzz + r2.xyz;
    ...
    r0.z = dot(v0.xyz, cb0[36].xyz);
    r0.w = -0.00999999978 + cb0[36].w;
    r0.w = cmp(r0.z < r0.w);
    r0.z = -cb0[36].w + r0.z;
    r2.xyz = -r0.zzz * cb0[36].xyz + v0.xyz;
    r2.w = 0;
    ...
    r2.x = r1.w * -r0.z;
    r2.x = cmp(r2.x < cb0[29].y);
    r3.xy = r2.xx ? cb0[29].xy : cb0[29].yz;
    r3.zw = r2.xx ? cb0[30].xy : cb0[30].yz;
    r1.w = -r0.z * r1.w + -r3.x;
    r2.xy = r3.yw + -r3.xz;
    r2.x = max(0.00100000005, r2.x);
    r1.w = saturate(r1.w / r2.x);
    r1.w = r1.w * r2.y + r3.z;
    r2.x = cb0[53].w * cb0[25].x;
    r1.w = r2.x * r1.w;
    r1.w = 100 * r1.w;
    r1.w = cb0[27].z * r1.w;
    ...
    r0.x = cmp(0 != cb0[40].y);
    r0.y = cmp(cb0[40].z < 0.949999988);
    r0.y = r0.y ? r0.x : 0;
    r0.z = cb1[6].x * cb0[55].w;
    r2.x = cb0[55].z * r1.w;
    r2.y = r0.z * r1.w;
    ...
    o2.xy = v4.xy * cb0[39].xy + cb0[39].zw;
    o0.xyzw = r1.xyzw;
    o1.xyz = cb0[26].xyz;
    o1.w = r0.w;
    o3.xyz = float3(0,0,0);
...
//
//   using 3Dmigoto v1.3.16 on Sat Jan 27 09:42:47 2024
//
//
// Input signature:
//
...
if_z r0.x
  ne r0.xy, l(0.000000, 0.000000, 0.000000, 0.000000), cb0[35].yzyy
  lt r0.z, |cb0[36].w|, l(0.001000)
  mul r1.xyz, cb0[36].wwww, cb0[36].xyzx
  ...
  mul r2.xyz, cb0[36].yyyy, cb3[5].xyzx
  mad r2.xyz, cb3[4].xyzx, cb0[36].xxxx, r2.xyzx
  mad r2.xyz, cb3[6].xyzx, cb0[36].zzzz, r2.xyzx
  ...
  dp3 r0.z, v0.xyzx, cb0[36].xyzx
  add r0.w, cb0[36].w, l(-0.010000)
  lt r0.w, r0.z, r0.w
  add r0.z, r0.z, -cb0[36].w
  mad r2.xyz, -r0.zzzz, cb0[36].xyzx, v0.xyzx
  mov r2.w, l(0)
  ...
  mul r2.x, -r0.z, r1.w
  lt r2.x, r2.x, cb0[29].y
  movc r3.xy, r2.xxxx, cb0[29].xyxx, cb0[29].yzyy
  movc r3.zw, r2.xxxx, cb0[30].xxxy, cb0[30].yyyz
  mad r1.w, -r0.z, r1.w, -r3.x
  add r2.xy, -r3.xzxx, r3.ywyy
  max r2.x, r2.x, l(0.001000)
  div_sat r1.w, r1.w, r2.x
  mad r1.w, r1.w, r2.y, r3.z
  mul r2.x, cb0[25].x, cb0[53].w
  mul r1.w, r1.w, r2.x
  ...
  mul r2.xyz, r2.xyzx, cb0[27].xxxx
  mul r2.xyz, r2.xyzx, cb0[27].zzzz
  ...
  ne r0.x, l(0.000000, 0.000000, 0.000000, 0.000000), cb0[40].y
  lt r0.y, cb0[40].z, l(0.950000)
  and r0.y, r0.y, r0.x
  mul r0.z, cb0[55].w, cb1[6].x
  mul r2.x, r1.w, cb0[55].z
  mul r2.y, r1.w, r0.z
  ...
  mad o2.xy, v4.xyxx, cb0[39].xyxx, cb0[39].zwzz
  mov o0.xyzw, r1.xyzw
  mov o1.xyz, cb0[26].xyzx
  mov o1.w, r0.w
  mov o3.xyz, l(0,0,0,0)
endif
ret
